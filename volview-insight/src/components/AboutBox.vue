<template>
  <v-card>
    <v-card-title class="d-flex flex-row justify-center">
      <volview-insight-full-logo />
    </v-card-title>
    <v-card-text>
      <h2 class="mt-2">About VolViewInsight</h2>
      <p>
        This is an open-source web application for the analysis of longitudinal imaging and medical record data in the NICU.
        It is developed at
        <a
        ...
        and is based on VolView.
        The work was supported by the National Institutes of Health under Award Number R42HL145669.
      </p>
      <v-divider class="mb-2" />
      <!-- Once we have a nice image to add, we can replace KitwareHeadAndNeck below. -->
      <!-- <p class="float-right">
        <v-img
          v-show="!mobile"
      ...
      <ul>
        <li>
          <span>VolViewInsight web application source code repo: </span>
          <a
            rel="noopener noreferrer"
            target="_blank"
            href="https://github.com/KitwareMedical/volview-insight"
          >
            https://github.com/KitwareMedical/volview-insight
          </a>
        </li>
        <li>
...
import VolViewInsightFullLogo from './icons/VolViewInsightFullLogo.vue';

export default defineComponent({
  name: 'AboutBox',
  components: {
    VolViewInsightFullLogo,
  },
  setup() {
