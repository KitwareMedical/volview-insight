...
import FHIRPatientsModule from './FHIRPatientsModule.vue';
import PatientImagesList from './PatientImagesListModule.vue';
...
const Modules: Module[] = [
  {
    ...
    component: FHIRPatientsModule,
  },
  {
    name: 'Images',
    icon: 'lungs',
    component: PatientImagesList,
  },
  {
    name: 'Annotations',
    icon: 'pencil',
